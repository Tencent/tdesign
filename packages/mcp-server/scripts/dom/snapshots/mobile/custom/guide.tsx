...
import GuideDemo from "@tdesign-mcp-server/docs-mobile-react/guide/Demo";
...
export default async () => {
  ...
  const guideSelectors = [".t-guide__overlay", ".t-guide__highlight", ".t-guide__wrapper", ".t-guide__popup"];
