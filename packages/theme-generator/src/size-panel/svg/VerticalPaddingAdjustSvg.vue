<template>
  <svg width="12" :height="viewHeight" :viewBox="`0 0 12 ${viewHeight}`" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      ...
      fill-opacity="0.16"
    />
    <!-- <path d="M0 16H12V21C12 22.6569 10.6569 24 9 24H3C1.34315 24 0 22.6569 0 21V16Z" fill="#D54941" fill-opacity="0.16"/> -->
...
const height = computed(() => Math.min(parseInt(props.size, 10) + 2, 12));
const viewHeight = computed(() => Math.min(12 + height.value * 2, 36));
</script>
