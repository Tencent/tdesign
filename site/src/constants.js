...
export const webSourceList = [
  ...
  },
  {
    ...
    description: '即时设计 & TDesign桌面端组件库资源',
    descriptionEn: 'Built-in desktop component resources',
    status: 0,
    icon: 'jssj',
    actionType: 'jump',
  ...
  },
  {
    ...
    description: 'Pixso & TDesign桌面端组件库资源',
    descriptionEn: 'Built-in desktop component resources',
    status: 0,
    icon: 'pixso',
    actionType: 'jump',
  ...
  },
  {
    ...
    description: '墨刀 & TDesign桌面端组件库资源',
    descriptionEn: 'Built-in desktop component resources',
    status: 0,
    icon: 'md',
    actionType: 'jump',
