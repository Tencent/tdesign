<template>
  <div ref="article" name="DESIGN" class="doc-icon">
    ...
    <h2>概述</h2>
    <p>
      Icon 作为 UI 构成中重要的元素，它一定程度上影响整体 UI 界面呈现出的风格，TDesign
      初期提供一套适用于中后台场景的线性 Icon，以普适、通用的标准进行设计，风格契合默认 TDesign 的风格，线性、圆角。
    </p>
    ...
    <p>
      ...
      图标的设计上实际画布应控制在栅格中心14*14px的区域，周围留有1px的出血。在一些特殊情况下如 icon
      过长或者有突出的边角等，允许内容适当延展，以确保图标视觉重量上的统一（ 超出部分建议为多边形的边角，并不宜超过
      0.5px ）
    </p>
